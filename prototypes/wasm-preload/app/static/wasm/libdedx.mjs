...
async function Module(moduleArg = {}) {
  ...
  (() => {
    ...
    var isWasmWorker =
      typeof ENVIRONMENT_IS_WASM_WORKER != "undefined" && ENVIRONMENT_IS_WASM_WORKER;
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = "preload/libdedx.data";
      var REMOTE_PACKAGE_BASE = "libdedx.data";
      ...
      async function runWithFS(Module) {
        ...
        async function processPackageData(arrayBuffer) {
          ...
          Module["removeRunDependency"]("datafile_preload/libdedx.data");
        }
        Module["addRunDependency"]("datafile_preload/libdedx.data");
    ...
    loadPackage({
      files: [
        { filename: "/data/README.md", start: 0, end: 2333 },
        { filename: "/data/raw/ASTAR.dat", start: 2333, end: 138757 },
        { filename: "/data/raw/ESTAR.dat", start: 138757, end: 292526 },
        { filename: "/data/raw/ICRU73.dat", start: 292526, end: 776358 },
        { filename: "/data/raw/ICRU73_NEW.dat", start: 776358, end: 797618 },
        { filename: "/data/raw/ICRU90_C.dat", start: 797618, end: 799871 },
        { filename: "/data/raw/ICRU90_a.dat", start: 799871, end: 801812 },
        { filename: "/data/raw/ICRU90_e.dat", start: 801812, end: 803756 },
        { filename: "/data/raw/ICRU90_p.dat", start: 803756, end: 806009 },
        { filename: "/data/raw/ICRU90_pos.dat", start: 806009, end: 807953 },
        { filename: "/data/raw/ICRU_ASTAR.dat", start: 807953, end: 899089 },
        { filename: "/data/raw/ICRU_PSTAR.dat", start: 899089, end: 998365 },
        { filename: "/data/raw/MSTAR.dat", start: 998365, end: 1143564 },
        { filename: "/data/raw/PSTAR.dat", start: 1143564, end: 1262523 },
        { filename: "/data/raw/astarEng.dat", start: 1262523, end: 1263870 },
        { filename: "/data/raw/betheEng.dat", start: 1263870, end: 1264705 },
        { filename: "/data/raw/effective_charge.dat", start: 1264705, end: 1265399 },
        { filename: "/data/raw/estarEng.dat", start: 1265399, end: 1266848 },
        { filename: "/data/raw/gas_states.dat", start: 1266848, end: 1266979 },
        { filename: "/data/raw/icru73Eng.dat", start: 1266979, end: 1267177 },
        { filename: "/data/raw/icru73_newEng.dat", start: 1267177, end: 1267375 },
        { filename: "/data/raw/icru90_CEng.dat", start: 1267375, end: 1268005 },
        { filename: "/data/raw/icru90_aEng.dat", start: 1268005, end: 1268547 },
        { filename: "/data/raw/icru90_eEng.dat", start: 1268547, end: 1269089 },
        { filename: "/data/raw/icru90_pEng.dat", start: 1269089, end: 1269719 },
        { filename: "/data/raw/icru90_posEng.dat", start: 1269719, end: 1270261 },
        { filename: "/data/raw/icru_90_raw.txt", start: 1270261, end: 1500448 },
        { filename: "/data/raw/icru_astarEng.dat", start: 1500448, end: 1501795 },
        { filename: "/data/raw/icru_pstarEng.dat", start: 1501795, end: 1502544 },
        { filename: "/data/raw/mstarEng.dat", start: 1502544, end: 1504395 },
        { filename: "/data/raw/pstarEng.dat", start: 1504395, end: 1505431 },
      ],
      remote_package_size: 1505431,
    });
  })();

  // end include: /tmp/tmp2ncusb2u.js
  // include: /tmp/tmp3ak8grj_.js
  ...
  if (
    ...
    (typeof ENVIRONMENT_IS_AUDIO_WORKLET != "undefined" && ENVIRONMENT_IS_AUDIO_WORKLET)
  )
    Module["preRun"] = [];
  var necessaryPreJSTasks = Module["preRun"].slice();
  // end include: /tmp/tmp3ak8grj_.js
  // include: /tmp/tmpr1r6faos.js
  ...
  // end include: /tmp/tmpr1r6faos.js
  ...
  function findWasmBinary() {
    if (Module["locateFile"]) {
      return locateFile("libdedx.wasm");
    }

    // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
    return new URL("libdedx.wasm", import.meta.url).href;
  }
  ...
  var _dedx_get_program_name = (Module["_dedx_get_program_name"] =
    makeInvalidEarlyAccess("_dedx_get_program_name"));
  var _dedx_fill_program_list = (Module["_dedx_fill_program_list"] =
    makeInvalidEarlyAccess("_dedx_fill_program_list"));
  ...
  function assignWasmExports(wasmExports) {
    assert(
      typeof wasmExports["dedx_get_program_name"] != "undefined",
      "missing Wasm export: dedx_get_program_name",
    );
    assert(
      typeof wasmExports["dedx_fill_program_list"] != "undefined",
      "missing Wasm export: dedx_fill_program_list",
    );
    ...
    _dedx_get_program_name = Module["_dedx_get_program_name"] = createExportWrapper(
      "dedx_get_program_name",
      1,
    );
    _dedx_fill_program_list = Module["_dedx_fill_program_list"] = createExportWrapper(
