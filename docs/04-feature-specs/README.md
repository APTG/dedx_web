...
| [plot.md](plot.md) | Draft v1 | Plot page: multi-series JSROOT chart, preview series, smart labels, full panel entity selection, 500-point log grid, keV/µm default, PNG/CSV export, URL-encoded series |
