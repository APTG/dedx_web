...
| [export.md](export.md) | Final v4 | Authoritative export spec across all three pages: shared toolbar (§0) places "Export PDF" + "Export CSV ↓" upper-right beside "Share URL" on all pages; image export ("Export image ▾" PNG/SVG dropdown) stays in Plot controls bar; advanced PDF layout: chart/table first, metadata block appended after (content-priority principle per 09-NFR §2); CSV schemas; filename conventions; accessibility contract |
