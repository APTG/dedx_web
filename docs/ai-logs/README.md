...
| File | Date | Topic |
|------|------|-------|
| [2026-04-13-export.md](2026-04-13-export.md) | 13 Apr 2026 | export.md Final v4: PDF + CSV in app toolbar beside "Share URL"; advanced PDF metadata after chart/table (not before); export.md v1–v4; calculator.md v8, plot.md v5; 09-non-functional-requirements.md Draft v1 (WCAG 2.1 AA, content-priority principle, performance, browser support) |
