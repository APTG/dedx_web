...
| File | Date | Topic |
|------|------|-------|
| [2026-04-08-multi-program.md](2026-04-08-multi-program.md) | 8 Apr 2026 | Multi-program spec Draft v2: columns grouped by quantity, drag-and-drop reorder, delta tooltip, onboarding hint, app-wide action bar toggle; product vision §4.4 updated to app-wide Advanced mode |
