...
| File | Date | Topic |
|------|------|-------|
| [2026-04-08-shareable-urls.md](2026-04-08-shareable-urls.md) | 8 Apr 2026 | Shareable URLs spec Draft v1→v3: canonical calculator/plot URL contract, consistency fixes, and explicit `urlv` versioning with major-mismatch warning + migration/recovery behavior |
