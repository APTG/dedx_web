...
| File | Date | Topic |
|------|------|-------|
| [2026-04-13-export.md](2026-04-13-export.md) | 13 Apr 2026 | export.md Final v2: adds PDF export (Plot + Calculator, jsPDF, mode-sensitive metadata block); external-data CSV rules (always Case B with ext: series, `#` comment rows per source); mixed-grid rule; "Export PDF" button in controls bar and below calculator table; cross-spec updates (calculator.md v7, plot.md v4, README.md) |
