...
| File | Date | Topic |
|------|------|-------|
| [2026-04-13-custom-compounds.md](2026-04-13-custom-compounds.md) | 13 Apr 2026 | custom-compounds.md Draft v1: compound library (localStorage + StoredCompound type), modal editor (Formula + Weight-fraction modes, live sum indicator, n_i = w_i / M_i conversion), entity-selection integration (Custom Compounds group, custom badge), calculateCustomCompound() wiring, Advanced Options interaction rules (density/I-value/aggregate-state disabled; interpolation/MSTAR active), URL encoding (material=custom + ccomp_* params, step 9 canonicalization), round-trip banner, export metadata, 13 AC groups, 3 open questions |
