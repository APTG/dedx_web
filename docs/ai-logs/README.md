...
| File | Date | Topic |
|------|------|-------|
| [2026-04-10-inverse-lookups.md](2026-04-10-inverse-lookups.md) | 10 Apr 2026 | Inverse Lookups spec Draft v1→v2: Range tab (renamed from Inverse CSDA, priority position); Inverse STP; getBraggPeakStp() WASM helper; shareable-urls-formal.md v5 (imode/ivalues/iunit ABNF + 6 conformance vectors); Open Question #2 resolved |
