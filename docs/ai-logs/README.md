...
| File | Date | Topic |
|------|------|-------|
| [2026-04-13-export.md](2026-04-13-export.md) | 13 Apr 2026 | export.md Final v5: toolbar order `[Export PDF][Export CSV ↓][Share URL]`; Calculator CSV column order (Normalized Energy first, STP last); advanced-mode CSV config modal (§1.1); PNG export advanced-mode only; BUILD moved to bottom of advanced PDF metadata; `Page n / N` PDF footer; export.md v1–v5; calculator.md v8, plot.md v5; 09-non-functional-requirements.md Draft v1 |
