...
| File | Date | Topic |
|------|------|-------|
| [2026-04-13-export.md](2026-04-13-export.md) | 13 Apr 2026 | export.md Final v1: authoritative export spec — Calculator basic (5-col CSV), Calculator advanced/multi-program (wide CSV, quantity-focus visibility, no delta cols), Plot image ("Export image ▾" dropdown: PNG + SVG) + Plot CSV (wide only, Case A/B grid handling); cross-spec updates to calculator.md, plot.md (Final v3, open questions #5/#6 resolved), multi-program.md, README.md |
