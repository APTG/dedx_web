...
| [`docs/02-tech-stack.md`](../02-tech-stack.md) | Final v3 | Full library inventory: SvelteKit 2, Svelte 5, TypeScript 5, Tailwind 4, shadcn-svelte + Bits UI, JSROOT 7, jsPDF 2, zarrita 0.7.x (replaces hyparquet — Spike 4), Vitest 4, Playwright 1, ESLint 9, Prettier 3, Emscripten 5.x, Node.js 24 LTS (24.14) |
| [`docs/03-architecture.md`](../03-architecture.md) | Final v1 | Project directory layout, routing, WASM service layer, state topology, component tree, data flows, URL sync, SSG constraints, error handling, accessibility |
