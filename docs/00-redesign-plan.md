...
- **Status:** Calculator core, live calc, multi-program comparison, Plot page, series
  comparison, URL sync, and basic-mode export are ✅ complete.
  Advanced Options, Inverse Lookups, Custom Compounds, Build Info, and advanced-mode
...
| 6.8  | Advanced Options panel                     | ⏳     | [`advanced-options.md`](04-feature-specs/advanced-options.md) Final v5           | Density override, I-value override, Gas/Condensed toggle, interpolation Axis scale + Method, MSTAR mode selector. Accordion in Calculator + Plot. **Prerequisite for 6.9 and 6.10.**                                                                                                 |
...
**Recommended implementation order:** 6.7 (standalone) → 6.8 → 6.9 → 6.11 → 6.10 → 6.12 → 6.13.
