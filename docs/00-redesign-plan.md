...
| 7.2 | JSROOT plot styling polish                          | ⏳     | [`plot.md`](04-feature-specs/plot.md)                                                               | No PR yet. Physics-grade defaults: log–log axes, axis labels with units, 14 pt fonts, legend top-right, line width 2, color palette. Must specify exact values — not "make it pretty"    |
